...
public abstract class AbstractBigInt<E : List<Int>>(
    ...
    public companion object {
        ...
        public inline fun Int.getL(): Long = this.toLong() and 0xffffffffL
        ...
        public inline fun IntArray.revGetL(index: Int): Long = this[lastIndex - index].getL()
        public inline fun IntArray.getL(index: Int): Long = this[index].getL()
        public inline fun IntArray.revSet(index: Int, value: Int) {
            this[lastIndex - index] = value
        }

        public inline fun IntArray.revSetL(index: Int, value: Long) {
            this[lastIndex - index] = value.toInt()
        }

        public inline fun IntArray.setL(index: Int, value: Long) {
        ...
        public inline fun <E : MutableList<Int>> E.revSet(index: Int, value: Int) {
            this[lastIndex - index] = value
        }

        public inline fun <E : MutableList<Int>> E.revSetL(index: Int, value: Long) {
            this[lastIndex - index] = value.toInt()
        }

        public fun <T : AbstractBigInt<*>> fromByteArray(
            value: ByteArray,
        ...
        public fun <E : List<Int>> bitLength(mag: E, sigNum: BigSigned): Int =
            if (mag.isNotEmpty()) {
                val size: Int =
                    bitSizeForInt(mag[0]) + ((mag.size - 1) * Int.SIZE_BITS)
