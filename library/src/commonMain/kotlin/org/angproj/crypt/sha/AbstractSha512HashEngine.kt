...
public abstract class AbstractSha512HashEngine : AbstractShaHashEngine(), UtilityAware {
    ...
    private fun push(chunk: ByteArray) = (0 until 16).forEach { i ->
        w[i] = chunk.readLongAt(i * wordSize).asNet()
    }
    ...
    public override fun final(): ByteArray {
        ...
        h.indices.forEach { hash.writeLongAt(it * wordSize, h[it].asNet()) }
